...
![Version: 1.15.0-bb.1](https://img.shields.io/badge/Version-1.15.0--bb.1-informational?style=flat-square) ![AppVersion: 1.15.0](https://img.shields.io/badge/AppVersion-1.15.0-informational?style=flat-square)
...
| tag | string | `"1.15.0"` | The tag to use for all images |
...
| tidTag | string | `"1.14.4-tetratefips-v0"` |  |
