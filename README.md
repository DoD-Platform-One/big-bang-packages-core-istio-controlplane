...
![Version: 1.14.2-bb.1](https://img.shields.io/badge/Version-1.14.2--bb.1-informational?style=flat-square) ![AppVersion: 1.14.2](https://img.shields.io/badge/AppVersion-1.14.2-informational?style=flat-square)
...
| tag | string | `"1.14.2"` | The tag to use for all images |
...
| gateways | object | `{"main":{"autoHttpRedirect":{"enabled":true},"selector":{"app":"istio-ingressgateway"},"servers":[{"hosts":["*.{{ .Values.domain }}"],"port":{"name":"https","number":8443,"protocol":"HTTPS"},"tls":{"credentialName":"wildcard-cert","minProtocolVersion":"TLSV1_2","mode":"SIMPLE"}}]}}` | See https://istio.io/latest/docs/reference/config/networking/gateway/#Gateway for spec |
| gateways.main | object | `{"autoHttpRedirect":{"enabled":true},"selector":{"app":"istio-ingressgateway"},"servers":[{"hosts":["*.{{ .Values.domain }}"],"port":{"name":"https","number":8443,"protocol":"HTTPS"},"tls":{"credentialName":"wildcard-cert","minProtocolVersion":"TLSV1_2","mode":"SIMPLE"}}]}` | This key becomes the name of the gateway |
...
| postInstallHook | object | `{"image":"registry1.dso.mil/ironbank/big-bang/base:2.0.0"}` | Big Bang postInstall "readiness" controls |
