...
![Version: 1.21.0-bb.0](https://img.shields.io/badge/Version-1.21.0--bb.0-informational?style=flat-square) ![AppVersion: 1.21.0](https://img.shields.io/badge/AppVersion-1.21.0-informational?style=flat-square)
...
| tag | string | `"1.21.0"` | The tag to use for all images |
