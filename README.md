...
![Version: 1.16.2-bb.0](https://img.shields.io/badge/Version-1.16.2--bb.0-informational?style=flat-square) ![AppVersion: 1.16.2](https://img.shields.io/badge/AppVersion-1.16.2-informational?style=flat-square)
...
| tag | string | `"1.16.2"` | The tag to use for all images |
...
| tidTag | string | `"1.16.1-tetratefips-v1"` |  |
