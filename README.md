...
![Version: 1.19.4-bb.2](https://img.shields.io/badge/Version-1.19.4--bb.2-informational?style=flat-square) ![AppVersion: 1.19.4](https://img.shields.io/badge/AppVersion-1.19.4-informational?style=flat-square)
...
| tag | string | `"1.19.4"` | The tag to use for all images |
